...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "มีต้องแต่ Robux, Blox Fruits, Brookhaven , Grow a garden และอื่นของ roblox ในที่เดียว" },
      { property: "og:title", content: "Prokim shop - ร้านไอเทมเกมพรีเมียม" },
      { property: "og:description", content: "มีต้องแต่ Robux, Blox Fruits, Brookhaven , Grow a garden และอื่นของ roblox ในที่เดียว" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Prokim shop - ร้านไอเทมเกมพรีเมียม" },
      { name: "twitter:description", content: "มีต้องแต่ Robux, Blox Fruits, Brookhaven , Grow a garden และอื่นของ roblox ในที่เดียว" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@500;600;700;800&family=IBM+Plex+Sans+Thai:wght@300;400;500;600;700&display=swap" },
