...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "ซื้อ Robux, Blox Fruits, Brookhaven , Grow a garden 2 , และอื่นของ roblox ในที่เดียว" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Prokim shop — ร้านไอเทมเกมพรีเมียม" },
      { name: "twitter:description", content: "ซื้อ Robux, Blox Fruits, Brookhaven , Grow a garden 2 , และอื่นของ roblox ในที่เดียว" },
